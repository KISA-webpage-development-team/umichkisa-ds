...
Avoid them unless there is a specific, justified reason.
Introducing extra breakpoints fragments the system and makes
responsive behavior harder to reason about.
