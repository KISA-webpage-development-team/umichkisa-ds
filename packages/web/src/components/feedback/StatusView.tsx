...
export type StatusViewProps = {
  ...
  action?: ReactNode;
  /** Cover the entire viewport (fixed, above page chrome) and center — for full-page status screens (error.tsx, auth gates, empty pages). Occludes any surrounding header/footer. */
  fullScreen?: boolean;
