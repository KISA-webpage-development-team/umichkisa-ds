...
const tabsTriggerVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        underline:
          "border-b-2 border-transparent -mb-px text-muted-foreground hover:text-foreground data-[state=active]:border-brand-accent data-[state=active]:text-foreground",
